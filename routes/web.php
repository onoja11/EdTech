...
Route::get('/dashboard', function () {
    ...
    Route::get('/lessons', [LessonController::class, 'view'])->name('lessons.view')->middleware('student', 'admin');
    Route::get('/lessons/create', [LessonController::class, 'create'])->name('lessons.create')->middleware('admin');
    Route::post('/lessons', [LessonController::class, 'store'])->name('lessons.store'); 
    Route::get('/lessons/{id}', [LessonController::class, 'show'])->name('lessons.show')->middleware(); 
